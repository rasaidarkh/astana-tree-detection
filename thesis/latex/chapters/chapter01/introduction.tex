...
\begin{longtable}[]{@{}p{0.225\linewidth} p{0.131\linewidth} p{0.272\linewidth} p{0.103\linewidth} p{0.188\linewidth}@{}}
\toprule\noalign{}
...
{\def\LTcaptype{none} % do not increment counter
\begin{longtable}[]{@{}p{0.215\linewidth} p{0.162\linewidth} p{0.058\linewidth} p{0.162\linewidth} p{0.324\linewidth}@{}}
\toprule\noalign{}
