...
\item
  Evaluate the resulting system in terms of detection quality, computational cost and practical applicability, and compare the four model branches against each other on a single dedicated validation set and against published baselines from the literature.
\end{enumerate}
