...
# сотни тайлов + прогоняет модель, 10+ под-регионов на CPU могут идти
# 10+ минут и забивать память Mask R-CNN'ом. UI говорит пользователю
# уменьшить bbox или сместить zoom.
DEFAULT_MAX_SUBREGIONS = 9
